...
const	ImplantDentureFocused = (props) => {
  const { md } = useBreakpoints();
	return (
    <div className={styles.containerImplantsDenture}>
      <h1 className={styles.title}>Full arch Implant Dentures</h1>
...
export default ImplantDentureFocused
