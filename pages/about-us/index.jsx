  ...
  return (
    <Layout>
      <Card className={styles.card}>
        ...
        <p>
          Affordable dentures and implants is a 100% digital practice. We don’t
          do ‘yucky’ and ‘gooy’ molds, they are a thing of the past. Every new
          smile is made using world leading 3D digital technology so that you
          can have the most precise and beautifully fitting smile.
          <br />
          <br />
          ...
          smile and eat to your best!
				...
				<img className={styles.heroImage} src="/png/about-us.png" alt="Woman smiling" />
