...
const AcrylicDentureFocused = (props) => {
  const { md } = useBreakpoints();
	return (
    <div className={styles.containerAcrylicDenture}>
      <h1 className={styles.title}>Acrylic dentures</h1>
...
export default AcrylicDentureFocused
